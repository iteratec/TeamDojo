...
```
$ kubectl get svc teamdojo -n teamdojo
```
...
```
$ kubectl scale deployment <app-name> --replicas <replica-count> -n teamdojo
```
...
```
$ kubectl set image deployment/<app-name>-app <app-name>=<new-image>  -n teamdojo
```
...
```
$ kubectl expose service jhipster-registry --type=NodePort --name=exposed-registry -n teamdojo
```

and explore the details using

```
$ kubectl get svc exposed-registry -n teamdojo
```

For scaling the JHipster registry, use

```
$ kubectl scale statefulset jhipster-registry --replicas 3 -n teamdojo
```

...
describe('Service Tests', () => {
  describe('Dimension Service', () => {
    ...
    beforeEach(() => {
      ...
      elemDefault = new Dimension(0, 'AAAAAAA', 'AAAAAAA', currentDate, currentDate);
    });
    ...
    describe('Service methods', () => {
      ...
      it('should not create a Dimension', async () => {
      ...
      it('should not update a Dimension', async () => {
      ...
      it('should partial update a Dimension', async () => {
      ...
      it('should not partial update a Dimension', async () => {
      ...
      it('should not return a list of Dimension', async () => {
        axiosStub.get.rejects(error);
      ...
      it('should not delete a Dimension', async () => {

...
describe('Service Tests', () => {
  describe('Training Service', () => {
    ...
    beforeEach(() => {
      ...
      elemDefault = new Training(0, 'AAAAAAA', 'AAAAAAA', 'AAAAAAA', 'AAAAAAA', currentDate, false, 'AAAAAAA', currentDate, currentDate);
    });
    ...
    describe('Service methods', () => {
      ...
      it('should partial update a Training', async () => {
      ...
      it('should not partial update a Training', async () => {

...
import com.iteratec.teamdojo.service.mapper.ActivityMapperImpl;
...
class ExtendedActivityServiceImplTest {

    private final ActivityRepository repo = mock(ActivityRepository.class);
    ...
    private final ExtendedActivityServiceImpl sut = new ExtendedActivityServiceImpl(
        repo,
        new ActivityMapperImpl(),
        badgeRepository,
        teamRepository,
        skillRepository
    );
    ...
    void save_modifyCreatedAtAndUpdatedAtToSameCurrentTimeIfEntityNotExists() {
        ...
        sut.setTime(time);
        final var input = new ActivityDTO();
        input.setId(23L);
    ...
    void save_modifyUpdatedAtToCurrentTimeIfEntityExists() {
        ...
        final var input = new ActivityDTO();
        input.setId(23L);
        final var persisted = new Activity();

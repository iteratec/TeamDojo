...
export default class Level extends mixins(JhiDataUtils) {
  ...
  public prepareRemove(instance: ILevel): void {
  ...
  public removeLevel(): void {
    this.levelService()
      ...
      .then(() => {
        const message = this.$t('teamDojoApp.level.deleted', { param: this.removeId });

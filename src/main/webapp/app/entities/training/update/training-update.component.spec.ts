  ...
  describe('Training Management Update Component', () => {
    ...
    describe('ngOnInit', () => {
      it('Should call Skill query and add missing value', () => {
        ...
        const skills: ISkill[] = [{ id: 89679 }];
        training.skills = skills;

        const skillCollection: ISkill[] = [{ id: 83374 }];
    ...
    describe('save', () => {
      it('Should call update service on save for existing entity', () => {
        ...
        spyOn(trainingService, 'update').and.returnValue(saveSubject);
      ...
      it('Should call create service on save for new entity', () => {
        ...
        spyOn(trainingService, 'create').and.returnValue(saveSubject);
        spyOn(comp, 'previousState');
        activatedRoute.data = of({ training });
        comp.ngOnInit();

...
export default class LevelSkill extends mixins(JhiDataUtils) {
  ...
  public retrieveAllLevelSkills(): void {
        ...
        res => {
          if (res.data && res.data.length > 0) {
            for (let i = 0; i < res.data.length; i++) {
              this.levelSkills.push(res.data[i]);
            }
  ...
  public prepareRemove(instance: ILevelSkill): void {
  ...
  public removeLevelSkill(): void {
    this.levelSkillService()
      .delete(this.removeId)
      .then(() => {
        const message = this.$t('teamDojoApp.levelSkill.deleted', { param: this.removeId });

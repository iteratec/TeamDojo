...
export default class BadgeSkill extends mixins(JhiDataUtils) {
  ...
  public retrieveAllBadgeSkills(): void {
        ...
        res => {
          if (res.data && res.data.length > 0) {
            for (let i = 0; i < res.data.length; i++) {
              this.badgeSkills.push(res.data[i]);
            }
  ...
  public prepareRemove(instance: IBadgeSkill): void {
  ...
  public removeBadgeSkill(): void {
    this.badgeSkillService()
      .delete(this.removeId)
      .then(() => {
        const message = this.$t('teamDojoApp.badgeSkill.deleted', { param: this.removeId });

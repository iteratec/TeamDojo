...
export default class Dimension extends mixins(JhiDataUtils) {
        ...
        res => {
          if (res.data && res.data.length > 0) {
            for (let i = 0; i < res.data.length; i++) {
              this.dimensions.push(res.data[i]);
            }
  ...
  public removeDimension(): void {
    this.dimensionService()
      ...
      .then(() => {
        const message = this.$t('teamDojoApp.dimension.deleted', { param: this.removeId });

...
import com.iteratec.teamdojo.config.ConstantsExtended;
import com.iteratec.teamdojo.config.audit.AuditEventConverter;
...
public class CustomAuditEventRepository implements AuditEventRepository {
    ...
    public void add(AuditEvent event) {
        if (!AUTHORIZATION_FAILURE.equals(event.getType()) && !ConstantsExtended.ANONYMOUS_USER.equals(event.getPrincipal())) {

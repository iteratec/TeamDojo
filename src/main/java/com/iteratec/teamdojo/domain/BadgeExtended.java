...
public class BadgeExtended extends Badge {
    ...
    public BadgeExtended id(Long id) {
        this.id = id;
        return this;
    }
    ...
    public BadgeExtended title(String title) {
        this.title = title;
        return this;
    }
    ...
    public BadgeExtended description(String description) {
    ...
    public BadgeExtended availableUntil(Instant availableUntil) {
    ...
    public BadgeExtended availableAmount(Integer availableAmount) {
    ...
    public BadgeExtended requiredScore(Double requiredScore) {
    ...
    public BadgeExtended createdAt(Instant createdAt) {
    ...
    public BadgeExtended updatedAt(Instant updatedAt) {
    ...
    public BadgeExtended skills(Set<BadgeSkill> badgeSkills) {
        this.setSkills(badgeSkills);
        return this;
    }

    public BadgeExtended addSkills(BadgeSkill badgeSkill) {
        this.skills.add(badgeSkill);
        badgeSkill.setBadge(this);
        return this;
    }

    public BadgeExtended removeSkills(BadgeSkill badgeSkill) {
    ...
    public BadgeExtended image(Image image) {
        this.setImage(image);
        return this;
    }
    ...
    public BadgeExtended dimensions(Set<Dimension> dimensions) {
        this.setDimensions(dimensions);
        return this;
    }

    public BadgeExtended addDimensions(Dimension dimension) {
        this.dimensions.add(dimension);
        dimension.getBadges().add(this);
        return this;
    }

    public BadgeExtended removeDimensions(Dimension dimension) {

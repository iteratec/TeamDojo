 ...
 * in {@link com.iteratec.teamdojo.web.rest.TeamGroupResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /team-groups?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
...
public class TeamGroupCriteria implements Serializable, Criteria {
    ...
    @Override
    public int hashCode() {
        return Objects.hash(id, title, description, createdAt, updatedAt, teamsId, parentId, distinct);
    }

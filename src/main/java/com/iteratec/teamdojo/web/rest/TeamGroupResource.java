...
public class TeamGroupResource {
    ...
    public ResponseEntity<List<TeamGroupDTO>> getAllTeamGroups(
        ...
        log.debug("REST request to get TeamGroups by criteria: {}", criteria.toString().replaceAll("[\n\r\t]", "_"));
    ...
    public ResponseEntity<Long> countTeamGroups(TeamGroupCriteria criteria) {
        log.debug("REST request to count TeamGroups by criteria: {}", criteria.toString().replaceAll("[\n\r\t]", "_"));
